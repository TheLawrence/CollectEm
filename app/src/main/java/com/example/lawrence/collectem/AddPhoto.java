...
public class AddPhoto extends ActionBarActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_CAMERA) {
                ...
                File file = new File(Environment.getExternalStorageDirectory().toString()+File.separator + "Collect\'Em");
                try {
                    file.createNewFile();
    ...
    public void addToDb(View view){
        ...
        Toast.makeText(this, "Picture \"" + photo.getTitle() + "\" added", Toast.LENGTH_LONG).show();
    }
}
